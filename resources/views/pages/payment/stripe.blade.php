...
@section('content')
                ...
                <div class="col-lg-7" style="border: 1px solid grey; padding: 20px; border-radius: 25px;">
                    <div class="contact_form_container">
                        ...
                        <ul class="list-group col-lg-4" style="float: right;">
                            ...
                            @else
                                <li class="list-group-item">Subtotal : <span style="float: right;">
                                        ${{ str_replace(',', '', Cart::subtotal()) }} </span> </li>
                            @endif
                            ...
                            @else
                                <li class="list-group-item">Total : <span
                                        style="float: right;">${{ str_replace(',', '', Cart::subtotal()) + $charge + $vat }}
                                    </span> </li>
                            @endif
                        </ul>
    ...
    <script type="text/javascript">
        ...
        var stripe = Stripe('pk_test_51IpecpCEeTTM3bygGa7OGn1NhbH2BPgzWX8WIXh6OJft0h24siqrDXhGN6gqUDiCOBvE3XoJaqs2kEPcBDR6mPTX00495KZhfD');
