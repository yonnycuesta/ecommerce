...
@endphp
 ...
 <a href="{{ route('all.blogpost')}}" class="btn btn-success btn-sm pull-right"> All Post</a>
       ...
       <form method="post" action="{{ url('update/post/'.$postedit->id) }}" enctype="multipart/form-data">    
        @csrf
            ...
            <div class="row mg-b-25">
              <div class="col-lg-6">
                <div class="form-group">
                  ...
                  <input class="form-control" type="text" name="post_title_en" value="{{ $postedit->post_title_en }}"  >
                </div>
              </div><!-- col-4 -->
              <div class="col-lg-6">
                <div class="form-group">
                  <label class="form-control-label">Post Title (HINDI): <span class="tx-danger">*</span></label>
                  <input class="form-control" type="text" name="post_title_in"  value="{{ $postedit->post_title_in }}">
                </div>
              </div><!-- col-4 -->
       ...
       <select class="form-control select2" data-placeholder="Choose country" name="category_id">
                    ...
                    <option value="{{ $row->id }}"
                  <?php if ($row->id == $postedit->category_id) {
                   echo "selected"; } ?> >
 ...
 <div class="col-lg-4">
          ...
          <img src="#" id="one">
               ...
               <img src="{{ URL::to($postedit->post_image) }}" style="height: 80px; width: 130px;">
               <input type="hidden" name="old_image" value="{{ $postedit->post_image }}">      
