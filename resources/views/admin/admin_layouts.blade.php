 ...
 <div class="sl-sideleft">
   <div class="sl-sideleft-menu">
    ...
    <ul class="sl-menu-sub nav flex-column">
     ...
     <li class="nav-item"><a href="{{ route('admin.seo.index') }}" class="nav-link">Seo</a></li>
    </ul>
    ...
    <ul class="sl-menu-sub nav flex-column">
      ...
      <li class="nav-item"><a href="{{ route('admin.proccess.payment')}}" class="nav-link">Proccess Delivery</a></li>
    ...
    <ul class="sl-menu-sub nav flex-column">
      <li class="nav-item"><a href="{{ route('admin.report.ordertoday') }}" class="nav-link">Today Order</a></li>
      <li class="nav-item"><a href="{{ route('admin.report.deliverytoday') }}" class="nav-link">Today Delivery</a></li>
    ...
    <ul class="sl-menu-sub nav flex-column">
      <li class="nav-item"><a href="blank.html" class="nav-link">Return Request</a></li>
      <li class="nav-item"><a href="page-signin.html" class="nav-link">All Request</a></li>
    </ul>
    @else
    ...
    <ul class="sl-menu-sub nav flex-column">
      <li class="nav-item"><a href="blank.html" class="nav-link">New Message</a></li>
      <li class="nav-item"><a href="page-signin.html" class="nav-link">All Message</a></li>  
    </ul>
    @else
    ...
    <ul class="sl-menu-sub nav flex-column">
      <li class="nav-item"><a href="blank.html" class="nav-link">New Comments</a></li>
      <li class="nav-item"><a href="page-signin.html" class="nav-link">All Comments</a></li>
    </ul>
    @else
